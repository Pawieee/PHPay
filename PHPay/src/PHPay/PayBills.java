...
public class PayBills extends JPanel {
	...
	public PayBills(String ID) {
		...
		transfer.setBounds(44, 200, 468, 509);
		...
		schoolButton.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				schoolButton.setBounds(45, 204, 72, 72);
			}

			@Override
			public void mouseExited(MouseEvent e) {
				schoolButton.setBounds(46, 205, 70, 70);
			}
		...
		travelButton.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				travelButton.setBounds(142, 204, 72, 72);
			}

			@Override
			public void mouseExited(MouseEvent e) {
				travelButton.setBounds(143, 205, 70, 70);
			}
		...
		loanButton.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				loanButton.setBounds(242, 204, 72, 72);
			}

			@Override
			public void mouseExited(MouseEvent e) {
				loanButton.setBounds(243, 205, 70, 70);
			}
		...
		telecomButton.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				telecomButton.setBounds(339, 204, 72, 72);
			}

			@Override
			public void mouseExited(MouseEvent e) {
				telecomButton.setBounds(340, 205, 70, 70);
			}
...
//				createBox(biller);
		...
		lblNewLabel_2_1_2_1.setBounds(46, 280, 70, 27);
		...
		lblNewLabel_2_1_2_1_1.setBounds(143, 280, 70, 27);
		...
		lblNewLabel_2_1_2_1_2.setBounds(243, 280, 70, 27);
		...
		lblNewLabel_2_1_2_1_3.setBounds(340, 280, 70, 27);
		...
		electricityBox.setBounds(46, 364, 376, 47);
		...
		waterBox.setBounds(46, 364, 376, 47);
		...
		cableBox.setBounds(46, 364, 376, 47);
		...
		healthBox.setBounds(46, 364, 376, 47);
		...
		schoolBox.setBounds(46, 364, 376, 47);
		...
		travelBox.setBounds(46, 364, 376, 47);
		...
		loanBox.setBounds(46, 364, 376, 47);
		...
		telecomBox.setBounds(46, 364, 376, 47);
		...
		billerLabel.setBounds(46, 326, 87, 27);
		...
		nextButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String choice = (String) getBox.getSelectedItem();
		...
		nextButton.setBounds(169, 441, 130, 34);
		...
		amountField.setBounds(79, 165, 376, 47);
		previewPane.add(amountField);
		amountField.setName("");
		...
		lblNewLabel_1_1_1_1_1_1_1.setBounds(79, 127, 87, 27);
		previewPane.add(lblNewLabel_1_1_1_1_1_1_1);
	...
	private void showNext(@SuppressWarnings("rawtypes") JComboBox box) {
