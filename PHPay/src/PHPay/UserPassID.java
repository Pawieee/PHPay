...
public class UserPassID extends JFrame implements Serializable {
    ...
    boolean userFieldEdited = false;
 	...
 	public static boolean isValidPass(String pass) {
 	    // Check if password is at least 8 characters and contains a combination of letters and numbers
	...
	public UserPassID() {
		...
		progressPanel.setBounds(RegisterButton.getBounds().x, RegisterButton.getBounds().y - 40, RegisterButton.getBounds().width, 20);
