...
public class HelpPanel extends JPanel {
	...
	public HelpPanel(String ID) {
		...
		pandtt2 = new JLabel("<html>\r\n<p style='font-size: 10px;'>\r\nIf you have a verified PHPAY account, there's no limit on the total amount of money you can send. You can send up to 60,000.00 USD in a single transaction, but we may limit that amount to 10,000.00 USD. These amounts can also vary depending on your currency.<br><br>\r\n\r\nIf you haven’t verified your PHPAY account, there will be a limit on the total amount of money you can send. You’ll be able to view this amount when you go to send money.\r\n</p>\r\n</html>\r\n");
