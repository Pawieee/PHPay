...
public class HelpPanel extends JPanel {
	...
	public HelpPanel(String ID) {
		...
		home_list.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				if (home_list.getSelectedValue().equals("How do I issue a refund?")) {
					...
					showh3();
				} else if (home_list.getSelectedValue()
						.equals("Why is the payment I sent pending or unclaimed? Can I cancel it?")) {
					showh4();
					...
					showh6();
						...
						.equals("How do I add money to my PHPAY account from my bank?")) {
					showh7();
		...
		pandt_list.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				if (pandt_list.getSelectedValue().equals("Can I cancel a withdrawal from my PHPAY account?")) {
					...
					showh1();
				} else if (pandt_list.getSelectedValue()
						.equals("How do I add money to my PHPAY account from my bank?")) {
					showh7();
				} else if (pandt_list.getSelectedValue()
						.equals("What‘s the maximum amount I can send with my PHPAY account?")) {
					showp2();
		...
		mw_list.setModel(new AbstractListModel() {
			private static final long serialVersionUID = 1L;
			String[] values = new String[] { "How do I add money to my PHPAY account from my bank?" };
		...
		mw_list.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (mw_list.getSelectedValue().equals("How do I link a bank account to my PHPAY account?")) {
					showmw1();
				} else if (mw_list.getSelectedValue()
						.equals("How do I link a debit or credit card to my PHPAY account?")) {
					showmw2();
		...
		lands_list.setModel(new AbstractListModel() {
			 ...
			 */
			private static final long serialVersionUID = 1L;
			String[] values = new String[] { "I forgot my password. How do I reset it?", "",
		...
		lands_list.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				if (lands_list.getSelectedValue().equals("I forgot my password. How do I reset it?")) {
					showh8();
				} else if (lands_list.getSelectedValue()
						.equals("How do I report potential fraud, spoof or unauthorized transactions to PHPAY?")) {
					showlands1();
		...
		home2l = new JLabel("<html><p style='font-size: 15px;'>How do I change my password?</p></html>");
		...
		home4l = new JLabel(
				"<html><p style='font-size: 15px;'>Why is the payment I sent pending or unclaimed? Can I cancel it?\r\n</p></html>");
		...
		home6l = new JLabel(
				"<html><p style='font-size: 15px;'>How do I remove a limitation from my account?\r\n</p></html>");
		...
		home7l = new JLabel(
				"<html><p style='font-size: 15px;'>How do I add money to my PHPAY account from my bank?</p></html>");
		...
		home8l = new JLabel(
				"<html><p style='font-size: 15px;'>I forgot my password. How do I reset it?\r\n</p></html>");
		...
		pandtl1 = new JLabel(
				"<html><p style='font-size: 15px;'>Can I cancel a withdrawal from my PHPAY account?\r\n</p></html>");
		...
		pandtl2 = new JLabel(
				"<html><p style='font-size: 15px;'>What‘s the maximum amount I can send with my PHPAY account?</p></html>");
		...
		main_panel.add(ma4t);
		mwl1 = new JLabel(
				"<html><p style='font-size: 15px;'>How do I link a bank account to my PHPAY account?</p></html>");
		...
		main_panel.add(mwt1);
		mwl2 = new JLabel(
				"<html><p style='font-size: 15px;'>How do I link a debit or credit card to my PHPAY account?</p></html>");
		...
		main_panel.add(mwt2);
		lands1l = new JLabel(
				"<html><p style='font-size: 15px;'>How do I report potential fraud, spoof or unauthorized transactions to PHPAY?</p></html>");
