...
public class HelpPanel extends JPanel {
	...
	public HelpPanel(String ID) {
		...
		home_list.setModel(new AbstractListModel() {
			private static final long serialVersionUID = 1L;
			String[] values = new String[] {"What's the maximum amount I can send with my PHPAY account?", "How do I receive money through PHPAY?", "What are the fees for PHPAY accounts?", "How do I add money to my PHPAY account?", "How do I change my password?", "Why is my account on hold?", "What is the Passkey for?", "Where can I see my account's activity?", "How do I submit a ticket?"};
			public int getSize() {
		...
		home_list.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				if (home_list.getSelectedValue().equals("What's the maximum amount I can send with my PHPAY account?")) {
					showh1();
				} else if (home_list.getSelectedValue().equals("How do I receive money through PHPAY?")) {
					showh2();
				} else if (home_list.getSelectedValue().equals("What are the fees for PHPAY accounts?")) {
					showh3();
				} else if (home_list.getSelectedValue().equals("How do I add money to my PHPAY account?")) {
					showh4();
				} else if (home_list.getSelectedValue().equals("How do I change my password?")) {
					showh5();
				} else if (home_list.getSelectedValue().equals("Why is my account on hold?")) {
					showh6();
				} else if (home_list.getSelectedValue().equals("What is the Passkey for?")) {
					showh7();
				} else if (home_list.getSelectedValue().equals("Where can I see my account's activity?")) {
					showh8();
				} else if (home_list.getSelectedValue().equals("How do I submit a ticket?")) {
					showh9();
				}
			}
		});
		...
		menu_list.setModel(new AbstractListModel() {
			 ...
			 */
			private static final long serialVersionUID = 1L;
			String[] values = new String[] {"Home", "", "", "", "", "", "", "", "", "", "", "", "", "Create a Ticket", "", "", ""};
			public int getSize() {
				return values.length;
			}
			public Object getElementAt(int index) {
		...
		home1l = new JLabel("<html><p style='font-size: 15px;'>What's the maximum amount I can send with my PHPAY account?</p></html>");
		home1l.setBounds(10, 11, 645, 30);
		main_panel.add(home1l);
		home1l.setFont(new Font("Leelawadee UI Semilight", Font.BOLD, 15));
		home1l.setVisible(false); 
		home1t = new JLabel("<html><p style='font-size: 11px;'>The maximum amount you can send with your PHPAY account has no limit but checks the interval of each especially when if it involves larger amounts PHPAY imposes certain limits to comply with anti-money laundering (AML) regulations and to ensure the security of your transactions. <br> <br>\r\n\r\nIt's important to note that exceeding certain transaction thresholds or sending large amounts of money continuously may trigger AML flags or additional scrutiny to prevent money laundering or fraudulent activities. \r\n\r\n.</html>");
		home1t.setBounds(10, 52, 865, 321);
		...
		home2l = new JLabel("<html><p style='font-size: 15px;'>How do I receive money through PHPAY?</p></html>");
		home2l.setForeground(Color.BLACK);
		home2l.setFont(new Font("Leelawadee UI Semilight", Font.BOLD, 22));
		home2l.setBounds(10, 11, 626, 30);
		home2l.setVisible(false); 
		main_panel.add(home2l);
		home2t = new JLabel("<html>\r\n<p style='font-size: 11px;'>Here's how to receive money through PHPAY.<br><br>\r\n1. Make sure you've created an account in PHPAY.\t<br>\r\n2. Provide your mobile number and account ID. <br>\r\n3. Wait for the transfer.<br>\r\n\r\n</p>\r\n</html>\r\n");
		...
		home3l = new JLabel("<html><p style='font-size: 15px;'>What are the fees for PHPAY accounts?\r\n</p></html>");
		home3l.setForeground(Color.BLACK);
		home3l.setFont(new Font("Leelawadee UI Semilight", Font.BOLD, 22));
		home3l.setBounds(10, 11, 552, 30);
		home3l.setVisible(false);
		main_panel.add(home3l);
		home3t = new JLabel("<html>\r\n<p style='font-size: 11px;'>\r\n\r\nThe fees for PHPAY accounts consist of a fixed fee of 3% for every transaction. This means that for any money transfer or payment you make or receive through PHPAY, a 3% fee will be deducted from the transaction amount. \r\n\r\n<br><br>There are no additional or hidden charges beyond this fixed 3% fee. PHPAY aims to keep its fee structure simple and transparent for its users.\r\n</html>");
		home3t.setVerticalAlignment(SwingConstants.TOP);
		home3t.setForeground(Color.BLACK);
		home3t.setFont(new Font("Leelawadee UI Semilight", Font.PLAIN, 22));
		home3t.setBounds(10, 52, 865, 337);
		home3t.setVisible(false);
		main_panel.add(home3t);
		home4l = new JLabel("<html><p style='font-size: 15px;'>How do I add money to my PHPAY account?\r\n</p></html>");
		home4l.setForeground(Color.BLACK);
		home4l.setFont(new Font("Leelawadee UI Semilight", Font.BOLD, 22));
		home4l.setBounds(10, 11, 440, 30);
		home4l.setVisible(false);
		main_panel.add(home4l);
		home4t = new JLabel("<html>\r\n<p style='font-size: 11px;'>\r\nTo add money into your PHPAY account; <br><br>\r\n\r\n1. Log-in to your account.<br>\r\n2. Press Wallet, select Cash-in.<br>\r\n3. Enter amount and wait for the status.\r\n\r\n.<br>\r\n</p>\r\n</html>\r\n");
		home4t.setVerticalAlignment(SwingConstants.TOP);
		home4t.setForeground(Color.BLACK);
		home4t.setFont(new Font("Leelawadee UI Semilight", Font.PLAIN, 22));
		home4t.setBounds(10, 52, 865, 337);
		home4t.setVisible(false);
		main_panel.add(home4t);
		home5l = new JLabel("<html><p style='font-size: 15px;'>How do I change my password?\r\n</p></html>");
		home5l.setForeground(Color.BLACK);
		home5l.setFont(new Font("Leelawadee UI Semilight", Font.BOLD, 22));
		home5l.setBounds(10, 11, 476, 30);
		home5l.setVisible(false);
		main_panel.add(home5l);
		home5t = new JLabel("<html>\r\n<p style='font-size: 11px;'>\r\nTo change your password,\r\n\r\n<br><br>1. Go to Sign-In page.<br>\r\n2. Click on Forgot Password.<br>\r\n3. Enter username, and enter passkey to change password.<br>\r\n\r\n</p>\r\n</html>\r\n");
		home5t.setVerticalAlignment(SwingConstants.TOP);
		home5t.setForeground(Color.BLACK);
		home5t.setFont(new Font("Leelawadee UI Semilight", Font.PLAIN, 22));
		home5t.setBounds(10, 52, 865, 337);
		home5t.setVisible(false);
		main_panel.add(home5t);
		home6l = new JLabel("<html><p style='font-size: 15px;'>Why is my account on hold?\r\n</p></html>");
		...
		home6t = new JLabel("<html>\r\n<p style='font-size: 11px;'>\r\nIf your account is on hold, <br>\r\n1. If your account is on hold, your account is probably flagged for suspicious transactions and actions are taken<br>\r\n2.Go to the \"Create a Ticket\" in the help section and provide an appeal ticket. <br>\r\n3. After submission, the admins will then assess whether the explanation you provided is/are valid to remove the on-hold status of your account.<br><br>\r\n\r\n</p>\r\n</html>\r\n");
		...
		home7l = new JLabel("<html><p style='font-size: 15px;'>What is the Passkey for?</p></html>");
		...
		home7t = new JLabel("<html>\r\n<p style='font-size: 11px;'>\r\nThe passkey is a unique identification that you can use to reset your account password.<br>\r\n\r\nWe strongly recommend to store it in a physical document.\r\n</p>\r\n</html>\r\n");
		...
		home8l = new JLabel("<html><p style='font-size: 15px;'>Where can I see my account's activity?\r\n</p></html>");
		...
		home8t = new JLabel("<html>\r\n<p style='font-size: 11px;'>\r\nTo view your account's activity; <br><br>\r\n\r\n1. Open Home and select Transactions.<br>\r\n2. There you can resize and open your account activity.<br>\r\n\r\n\r\n.<br>\r\n</p>\r\n</html>\r\n");
		...
		home9l = new JLabel("<html><p style='font-size: 15px;'>How do I submit a ticket?\r\n</p></html>");
		home9l.setForeground(Color.BLACK);
		home9l.setFont(new Font("Leelawadee UI Semilight", Font.BOLD, 22));
		home9l.setBounds(0, 0, 259, 44);
		home9l.setVisible(false);
		main_panel.add(home9l);
		
		home9t = new JLabel("<html>\r\n<p style='font-size: 11px;'>\r\nTo create a ticket you need to; <br><br>\r\n\r\n1. Open Help.<br>\r\n2. Select Create a ticket.<br>\r\n3. After you're finish click submit.<br>\r\n\r\n\r\n.<br>\r\n</p>\r\n</html>\r\n");
		home9t.setVerticalAlignment(SwingConstants.TOP);
		home9t.setForeground(Color.BLACK);
		home9t.setFont(new Font("Leelawadee UI Semilight", Font.PLAIN, 22));
		home9t.setBounds(10, 52, 865, 337);
		home9t.setVisible(false);
		main_panel.add(home9t);
		...
		int maxChar = 300;
	    AbstractDocument doc = (AbstractDocument) EPane1.getDocument();
	    ...
	    doc.addDocumentListener(new DocumentListener() {
	        ...
	        private void updateCharCountLabel() {
	            int remainingChars = maxChar - EPane1.getDocument().getLength();
	            CountLabel.setText(remainingChars + " characters remaining");
	        }
	    });
		 
		TButton = new JButton("Submit Ticket");
		TButton.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
		...
		bl12.addMouseListener(new MouseAdapter() {
		 ...
		 private void showh9() {
			 ...
			 mw_list.setVisible(false);
			 lands_list.setVisible(false);
			 home9l.setVisible(true);
			 home9t.setVisible(true);
